...
lwn_regions: Dict[str, Set[str]] = {
    ...
    "Lava Ruins - After scissor enemy barrier": {"Lava Ruins - After magic platforms", "Lava Ruins - After Fire Barrier", "Lava Ruins - After Moving Ring"},
    "Lava Ruins - After Fire Barrier": {"Lava Ruins - After scissor enemy barrier", "Lava Ruins - After Moving Ring"},
    "Lava Ruins - After Moving Ring": {"Lava Ruins - After Fire Barrier", "Lava Ruins - After scissor enemy barrier", "Lava Ruins - Monica"},
    ...
    "Dark Tunnel - After thunder barrier": {"Dark Tunnel - Thunder barrier", "Dark Tunnel - After floating platforms"},
