...
lwn_regions: Dict[str, Set[str]] = {
    ...
    "Shrine - Armor Hall": {"Secret passage - Start", "Secret passage - After secret passage gate", "Secret Passage - Boss Shortcut", "Shrine - Underground shortcut", "Shrine - Cat Room", "Underground - Start"},
