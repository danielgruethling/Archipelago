...
lwn_regions: Dict[str, Set[str]] = {
    ...
    "Dark Tunnel - Start": {"Dark Tunnel - After first magic barrier", "Lava Ruins - Path to dark tunnel"},
    "Dark Tunnel - After first magic barrier": {"Dark Tunnel - Start", "Dark Tunnel - After first gate"},
    "Dark Tunnel - After first gate": {"Dark Tunnel - After first magic barrier", "Dark Tunnel - After light switch barrier"},
